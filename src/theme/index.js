export default {
	...
	"font": {
		"headline1": "normal 600 68px/1 --fontFamily-googleRoboto",
		"headline2": "normal 900 42px/1.2 --fontFamily-sans",
		"headline3": "normal 500 28px/1.2 --fontFamily-sans",
		"base": "normal 400 16px/1.5 --fontFamily-googleRoboto",
		"lead": "normal 300 20px/1.5 --fontFamily-sans",
		"logo": "normal 400 23px --fontFamily-googleRoboto",
		"logo2": "normal small-caps 400 14px/1.3 --fontFamily-googleRoboto"
	},
	"boxShadow": {
